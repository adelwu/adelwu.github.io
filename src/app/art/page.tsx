...
export default function ArtPage() {
  return (
    <div>
      {/* Hero Section */}
      <section className="max-w-content mx-auto px-6 md:px-12 lg:px-16 py-24 md:py-32">
      ...
      <section className="mb-16 md:mb-24">
        <p className="text-center text-sm text-text-tertiary uppercase tracking-widest mb-8">
          Trusted by
        </p>
      ...
      {/* Portfolio Gallery */}
      <section className="max-w-content-wide mx-auto px-6 md:px-12 lg:px-16 mb-16 md:mb-24">
        ...
        <p className="text-center text-text-tertiary mt-8 text-sm">
          Add images to <code className="text-xs bg-bg-muted px-2 py-1 rounded">public/images/portfolio/</code>
        </p>
      </section>

      {/* Instagram Link */}
      <section className="max-w-content mx-auto px-6 md:px-12 lg:px-16 py-16 md:py-24 border-t border-border-default text-center">
      ...
      <section className="max-w-content mx-auto px-6 md:px-12 lg:px-16 py-16 md:py-24 border-t border-border-default">
        ...
        <p className="text-text-secondary mb-12 max-w-form">
