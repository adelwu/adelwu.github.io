...
const contactMethods = [
  ...
  },
  {
    name: "LinkedIn",
    value: "Adel Wu",
    href: "https://www.linkedin.com/in/adelwu/",
    icon: (
      <svg className="w-6 h-6" fill="currentColor" viewBox="0 0 24 24">
    ...
    <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
      ...
      <div className="max-w-2xl mx-auto">
        <div className="grid gap-6">
          {contactMethods.map((method) => {
            const href = method.href === "email" ? getEmailHref() : method.href;
            ...
            return (
              <a
                ...
                className="flex items-center p-6 bg-gray-50 rounded-xl hover:bg-gray-100 transition-colors group"
              >
                <div className="w-12 h-12 bg-white rounded-full flex items-center justify-center text-gray-600 group-hover:text-gray-900 transition-colors shadow-sm">
                  {method.icon}
                </div>
                <div className="ml-4">
                ...
                <svg
                  className="w-5 h-5 ml-auto text-gray-400 group-hover:text-gray-600 transition-colors"
                  fill="none"
                  stroke="currentColor"
                  viewBox="0 0 24 24"
                >
      ...
      <div className="text-center mt-16 pt-16 border-t border-gray-200">
        ...
        <p className="text-gray-600 mb-6">
          Fill out my event inquiry form with details about your upcoming event.
        </p>
        <Link
          href="/art"
