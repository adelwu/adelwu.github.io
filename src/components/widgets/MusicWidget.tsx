...
const DEFAULT_SPOTIFY_URI = "playlist/02CZThhljTfxcFJD9unl9Q";
...
export default function MusicWidget({
  ...
  return (
    <div className={`rounded-card overflow-hidden relative ${className}`}>
      {isLoading && (
        <div className="absolute inset-0 flex items-center justify-center bg-bg-muted animate-pulse z-10">
          <svg
